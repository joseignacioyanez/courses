...
const pointLight = new THREE.PointLight(0xff9000, 0.7, 10, 2)
pointLight.position.set(1.2, -0.5, 1)
...
const spotLight = new THREE.SpotLight(0x78ffff, 0.5, 10, Math.PI*0.1, 0.25, 1)
